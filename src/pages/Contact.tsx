            ...
            <div className="grid items-center md:grid-cols-2 gap-8 lg:gap-12">
              <div>
                ...
                >
                  ...
                  <p className="text-[#262626] font-light mb-3">
                    Email, call, or complete the form to reach Eight Geeks at
                    Law easily.
                  </p>
                  <p className="text-[#262626] font-light mb-3">
                    info@theeightgeeks.com
                  </p>
                  <p className="text-[#262626] font-light">
              ...
              <div>
                ...
                >
                  ...
                  <p className="text-[#262626] text-base my-2">
                    East Legon - Nii Afutu Tsuru Street <br /> GD-185-4362{" "}
                    <br /> Accra, Ghana
                  </p>
                </div>
              </div>
